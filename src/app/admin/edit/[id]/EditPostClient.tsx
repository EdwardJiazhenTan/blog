      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <header className="mb-8 pb-6 border-b border-opacity-20 flex items-center justify-between" style={{borderColor: 'var(--foreground)'}}>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/admin/dashboard" className="text-sm px-3 py-1 border border-opacity-30 rounded-lg hover:border-opacity-60 transition-all font-handwriting" style={{color: 'var(--foreground)', borderColor: 'var(--foreground)'}}>
              Back to Dashboard
            </Link>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium mb-2 font-handwriting" style={{color: 'var(--foreground)'}}>
                Excerpt
              </label>
              <textarea
                value={excerpt}
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-opacity-20 p-4" style={{
            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                <Link href="/admin/dashboard" className="text-sm px-4 py-2 opacity-60 hover:opacity-100 transition-opacity font-handwriting" style={{color: 'var(--foreground)'}}>
                  Cancel
                </Link>
