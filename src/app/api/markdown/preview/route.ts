...
export async function POST(request: NextRequest) {
  try {
    ...
    html = html
      ...
      // Code blocks
      .replace(/<pre><code>/g, '<div class="snoopy-card my-10"><pre class="p-6 rounded-lg overflow-x-auto font-mono text-sm" style="background-color: rgba(45, 27, 23, 0.05); color: var(--foreground)"><code>')
